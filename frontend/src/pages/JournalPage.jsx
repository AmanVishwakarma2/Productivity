...
function JournalPage() {
  ...
  const updateTaskCompletionMutation = useMutation({
    mutationFn: async () => {
      const response = await fetch(`${API_URL}/progress/journal`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-800 ">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white border rounded-lg p-6 dark:bg-gray-800 hover:shadow-lg transition-shadow shadow-2xl">
          <h2 className="text-xl font-semibold dark:text-white mb-4 hover:shadow-lg transition-shadow shadow-2xl">
          ...
          {isLoadingEntries ? (
            ...
            <div className="space-y-4 hover:shadow-lg transition-shadow shadow-2xl">
              {entries.length === 0 ? (
                <p className="text-gray-500 text-center py-4 dark:text-white">
                ...
                entries.map((entry) => (
                  <div
                    key={entry._id}
                    className="border-b pb-4 dark:text-white mb-4 last:border-0 hover:shadow-lg transition-shadow shadow-2xl"
                  >
                    ...
                    <p className="text-gray-700 mb-4 whitespace-pre-line dark:text-white">
                      {entry.content}
                    </p>
